...
let url = `https://newsapi.org/v2/everything?q=apple&apiKey=454ce9bf232f426c935fbde79926d129&page=${currentPage}`;
...
if(searchTerm){
    url = `https://newsapi.org/v2/everything?q=${searchTerm}&apiKey=454ce9bf232f426c935fbde79926d129`
}else{
    url = `https://newsapi.org/v2/everything?q=apple&apiKey=454ce9bf232f426c935fbde79926d129&page=${currentPage}`;
}
